 ...
 */
@AutoConfiguration
public class RegisterHttpAutoConfiguration {

    @Bean
    @ConditionalOnMissingBean(HttpCookieParser.class)
    public HttpCookieParser httpCookieParser() {
        return new DefaultHttpCookieParser();
    }
}
