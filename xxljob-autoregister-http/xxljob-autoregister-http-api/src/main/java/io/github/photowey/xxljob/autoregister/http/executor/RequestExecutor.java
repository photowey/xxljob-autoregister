 ...
 * @since 2025/07/09
 */
public interface RequestExecutor extends Ordered, BeanFactoryGetter, XxljobPropertiesGetter {

    default <R> HttpResponse<R> get(String url, Class<R> responseType) {
        throw new UnsupportedOperationException("Unsupported now");
    }

    default <R> HttpResponse<R> get(String url, HttpHeaders headers, Class<R> responseType) {
        throw new UnsupportedOperationException("Unsupported now");
    }
